function plot_group_PSTH(responsive_units_struct, params)
    ...
    % Get the group names (e.g., 'Control', 'Pvalb')
    ...
    for g = 1:length(groupNames)
        ...
        % Define response types with correct labeling
        ...
        for rt = 1:length(responseTypes)
            ...
            for r = 1:numRecordings
                ...
                for u = 1:length(units)
                    ...
                    if ~isfield(unitData, 'ResponseType') || ~isfield(unitData, 'PSTH_Label')
                    ...
                    if strcmp(unitData.ResponseType, responseType)
                        ...
                        smoothedPSTH = conv(unitData.PSTH_Label, params.smoothingWindow, 'same');
